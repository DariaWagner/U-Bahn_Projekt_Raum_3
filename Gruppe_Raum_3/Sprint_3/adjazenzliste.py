...
STATIONEN_U1 = {
    "LANGWASSER SÜD": [{
        ...
        "linie": "U1",
        "fahrtzeit": 3,
        "umsteigezeit": 60  # Endhaltestelle (Haltezeit in Sekunden)
    }],
    "GEMEINSCHAFTSHAUS": [{
...
# HILFSLISTEN (für Kompatibilität mit Sprint 2/3 Code)

# Reihenfolge der Stationen
STATIONEN_REIHENFOLGE = list(STATIONEN_U1.keys())

# Haltezeiten in Sekunden (aus umsteigezeit)
HALTEZEITEN = {
